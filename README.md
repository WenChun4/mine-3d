...
REACT_APP_IMJS_AUTH_CLIENT_CLIENT_ID=""
REACT_APP_IMJS_AUTH_CLIENT_REDIRECT_URI=""
REACT_APP_IMJS_AUTH_CLIENT_LOGOUT_URI=""
REACT_APP_IMJS_AUTH_CLIENT_SCOPES =""
```
...
```
# ---- Test ids ----
REACT_APP_IMJS_ITWIN_ID = ""
REACT_APP_IMJS_IMODEL_ID = ""
```

- For the REACT_APP_IMJS_ITWIN_ID variable, you can use the id of one of your existing iTwins. You can obtain their ids via the [iTwin REST APIs](https://developer.bentley.com/apis/itwins/operations/get-itwin/).

- For the REACT_APP_IMJS_IMODEL_ID variable, use the id of an iModel that belongs to the iTwin that you specified in the REACT_APP_IMJS_ITWIN_ID variable. You can obtain iModel ids via the [iModel REST APIs](https://developer.bentley.com/apis/imodels-v2/operations/get-imodel-details/).
