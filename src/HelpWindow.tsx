        ...
        <ModalContent>
            ...
            <div id='row1' className='subcontainer clearfix:after'>
              <div id='div1' className='left'>
                ...
                <Text variant='body'><b className='highlighttext'>Left click</b> on a box to <b className='highlighttext'>explore</b></Text>
              </div>
            ...
            <Flex flexDirection='column' alignItems='start' gap='10px'>
              ...
              <Text variant='leading' className='tab'>iTwin UI Resources: <a href='https://itwinui.bentley.com/docs' target="_blank">Document</a>.</Text>
              ...
              <Text variant='leading' className='tab'>How to deploy react SPA to Docker: <a href='https://chatgpt.com/' target="_blank">ChatGPT</a>.</Text>
              <Text variant='leading' className='tab'>How to use public resources to host a React site: <a href='https://chatgpt.com/' target="_blank">ChatGPT</a>.</Text>
              <p/>
            </Flex>    
        </ModalContent>
      </Modal>
